         ...
         do
         {
            switch(jjstateSet[--i])
            {
               ...
               case 5:
                  ...
                  break;
               case 6:
                  if ((0x280000000000L & l) != 0L && kind > 4)
                     kind = 4;
                  break;
               case 7:
...
"", null, "\75", null, null, null, "\73", null, null, null, null, };
...
/** Get the next Token. */
public static Token getNextToken(List<TokenYTipo> listaDeTokens) 
{
  Token matchedToken;
  int curPos = 0;
  ...
  for (;;)
  {
   ...
   if (jjmatchedKind != 0x7fffffff)
   {
      ...
      {
         matchedToken = jjFillToken();
         TokenLexicalActions(matchedToken, listaDeTokens);
         return matchedToken;
      }
      else
      {
...
static void TokenLexicalActions(Token matchedToken, List<TokenYTipo> listaDeTokens)
{
